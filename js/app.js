        ...
        <div class="detail-info">
            ...
            <div class="detail-quantity">
                ...
                <div class="quantity-controls">
                    <button onclick="changeDetailQuantity(-1)" id="detailMinus">-</button>
                    <span id="detailQuantity">1</span>
                    <button onclick="changeDetailQuantity(1)">+</button>
                </div>
            </div>

            <button class="confirm-button" onclick="addProductFromDetail()">
                Agregar al carrito
            </button>
        </div>
    `;
...
confirmOrder.addEventListener("click", () => {
    ...
    const number = String(currentOrderNumber).padStart(3, "0");
...
function createOrderSummary() {
    ...
    orderSummaryTotal.textContent = `S/ ${total.toFixed(2)}`;
}
